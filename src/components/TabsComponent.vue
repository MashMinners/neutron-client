<template>
  <div>
    <Tabs value="0">
      <TabList>
        <Tab value="0">Пересчения с прошлым месяцем (УДАЛИТЬ ИЗ РЕЕСТРА)</Tab>
        <Tab value="1">Пересечения с прошлым месяцем (30 +++)</Tab>
        <Tab value="2">Пересечения с прошлым месяцем (Часть норм, часть удалить)</Tab>
      </TabList>
      <TabPanels>
        <TabPanel value="0">
